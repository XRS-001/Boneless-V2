...
public class BulletImpact : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            collision.collider.GetComponent<DecalSurface>().ImpactEffect(collision.contacts[0].point + Quaternion.LookRotation(collision.contacts[0].normal) * Vector3.forward / 10, Quaternion.LookRotation(collision.contacts[0].normal));
        }
